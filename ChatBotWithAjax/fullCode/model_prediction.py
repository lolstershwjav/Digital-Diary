...
train_data = pd.read_csv("fullCode/static/assets/data_files/tweet_emotions.csv")   
...
model = load_model("fullCode/static/assets/model_files/Tweet_Emotion.h5")
...
def show_entry():
    day_entry_list = pd.read_csv("fullCode/static/assets/data_files/data_entry.csv")
